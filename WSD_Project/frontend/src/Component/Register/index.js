...
function Index() {
    ...
    const handlechange = ({ currentTarget: input }) => {
      ...
      const handlesubmit = async (e) => {
        ...
        const res =await axios.post("https://localhost:7153/api/Auth/Register",{
            username,
            password
        })
        ...
        console.log("errror in registeration")
  ...
  return (
    ...
    <div class="h-screen overflow-hidden flex items-center justify-center" style={{backgroundColor: "white"}}>
                    ...
                    <div class="flex -mx-3">
                        <div class="w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" onChange={handlechange} name="username"class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John"/>
                            </div>
                        </div>
                        <div class="w-1/2 px-3 mb-5">
                    ...
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                ...
                                <input type="password"onChange={handlechange} name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************"/>
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button type='submit' class="block w-full max-w-xs mx-auto bg-gradient-to-r from-blue-300 to-blue-600 hover:bg-gradient-to-r from-blue-400 to-blue-700 focus:bg-gradient-to-r from-blue-300 to-blue-600 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                        </div>
                    </div>
                </div>
            </div>
